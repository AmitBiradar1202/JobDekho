...
const MyJobs = () => {
 ...
 const handleDeleteJob=async(elementID)=>{
        const DeletedJob=await axios
                              .delete(`http://localhost:4000/api/v1/job/delete/${elementID}`
                              ,{withCredentials:ture
                                })
                                .then((res) => {
                                  toast.success(res.data.message);
                                  setMyJobs((Jobs) => prevJobs.filter((job) => job._id !== elementID));
                                })
                                .catch((error) => {
                                  toast.error(error.response.data.message);
                                });       
